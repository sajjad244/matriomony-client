    ...
    <div className="container mx-auto my-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <p className="text-4xl text-blue-500 font-bold mt-3">
            {totalBiodata}
          </p>
        </div>
        {/* Male Biodata */}
        <div className="bg-white shadow-md rounded-lg p-6">
          <h3 className="text-2xl font-semibold text-gray-800">Male Biodata</h3>
          <p className="text-4xl text-green-500 font-bold mt-3">{totalMales}</p>
        </div>
        {/* Female Biodata */}
        <div className="bg-white shadow-md rounded-lg p-6">
          <h3 className="text-2xl font-semibold text-gray-800">
          ...
          <p className="text-4xl text-pink-500 font-bold mt-3">
            {totalFemales}
          </p>
        </div>
        {/* Married Couples */}
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <p className="text-4xl text-purple-500 font-bold mt-3">
            {totalMarriedCouples}
          </p>
        </div>
      </div>
